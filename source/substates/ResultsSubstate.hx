...
class ResultsSubstate extends MusicBeatSubstate
{
  ...
  public function new(params:ResultsStateParams)
  {
    ...
    /*if(PlayState.storyPlaylist.length > 0 || Options.getData("skipResultsScreen")){
      ...
      if (rank.hasMusicIntro())
        {
            ...
            introSound.play();
            introSound.onComplete = () -> { FlxG.sound.playMusic(rank.getMusicPath(), 1,  rank.shouldMusicLoop()); };
